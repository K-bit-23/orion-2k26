const eventData = [
    ...
    },
    {
        ...
        subtitle: "(Short Film)",
        icon: "fa-video",
        description: "A short film competition challenging participants to showcase their storytelling and cinematic skills. Select from various **THEMES** ranging from campus life to social change. AI tools are permitted for enhancement.",
        teamSize: "Max 5 Members",
        rules: [
            "Duration: 1-5 minutes only.",
            "Must follow one of the themes:",
            "• Campus Diaries – Youth & College Life",
            "• Tradition vs Tomorrow – Culture & Change",
            "• Village Dreams, City Rush – Village Life vs City Life",
            "• When Skills Go Silent – Technology & Unemployment",
            "• Chalk to Change – Power of Education",
